...
# class Parallel_MTGNN(nn.Module):
...
#             x = x + residual[:, :, :, -x.size(3):]   # 残差连接提前
#             if self.gcn_true:
#                 x_1, x_2 = torch.chunk(x, chunks=2, dim=-2)  # 分出I和P的高维时间特征
#                 x = self.gconv1[i](x_1, adp) + self.gconv2[i](x_2, adp)
#             else:
